...
```bash
openclaw skills install ZampoRen/flow-hugo-publisher
```

### 方式 2：手动克隆

```bash
git clone https://github.com/ZampoRen/flow-hugo-publisher.git ~/.openclaw/skills/flow-hugo-publisher
...
- [完整教程](https://github.com/ZampoRen/flow-hugo-publisher)
