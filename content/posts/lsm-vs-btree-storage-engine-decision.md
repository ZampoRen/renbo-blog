...
![B+Tree 页分裂示意图](/images/lsm-vs-btree-storage-engine-decision/inline-01-btree-split.png)
...
![LSM 写入四步链路](/images/lsm-vs-btree-storage-engine-decision/inline-02-lsm-write.png)
...
![B+Tree vs LSM 取舍三角对比](/images/lsm-vs-btree-storage-engine-decision/inline-03-tradeoff.png)
