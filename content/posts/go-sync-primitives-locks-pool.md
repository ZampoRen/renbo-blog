...
我跑了一组简化 benchmark，环境是 Go 1.25.4、darwin/arm64、Apple M1 Pro。数据只能说明观察方向，不能外推成普适结论：
...
我第一次看到 Pool 时，也自然把它理解成对象池：我 Put 进去，后面 Get 出来，减少分配，性能变好。
