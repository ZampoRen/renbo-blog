---
title: "close(ch) 不是关门，是把所有等待的人同时叫醒"
description: "沿着 Go 1.25.4 runtime/chan.go 拆开 chanrecv、无缓冲 channel 的栈间拷贝、closechan 批量唤醒，以及 nil channel 和 closed channel 为什么不是一类边界。"
